...
for (col in voc_columns) {
  dat[[col]] <- ifelse(dat[[col]] < detection_limit[[col]], 0, dat[[col]])
}
...
#ggsave("/Users/AU775281/Documents/PhD/Flavia Experiment/DFC VOC/Adjusted/Figure/VOC flux sd zero.png", plot = vocplot)
...
#ggsave ("/Users/AU775281/Documents/PhD/Flavia Experiment/DFC VOC/Adjusted/Figure/VOC flux sd zero grouped.png", plot = vocflux)
...
#ggsave ("/Users/AU775281/Documents/PhD/Flavia Experiment/DFC VOC/Adjusted/Figure/cumulative SD 2 zero treatments.png", plot = cumsum_plot)
...
#ggsave ("/Users/AU775281/Documents/PhD/Flavia Experiment/DFC VOC/Adjusted/Figure/cumulative SD 2 Zero grouped.png", plot = grouped)
