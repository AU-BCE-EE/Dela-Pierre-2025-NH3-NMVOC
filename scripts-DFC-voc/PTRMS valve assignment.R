...
a<-readCRDS("Blank", 
            ...
            mult = T, 
            tz = "UTC", 
            rm = F) #Picarro data not uploaded in Github, can be obtained by contacting Flavia Dela Pierre
#reading in PTRMs data
dt <- read_csv("../input-DFC/VOC_DFC_ppb.txt")
...
write.table(dt, "../output-DFC/raw.ptrms.valve.txt", row.names = F, sep=",")
